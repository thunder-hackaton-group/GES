<?php
    ...
    $ins = $db->prepare('INSERT INTO Etablissement(id_etablissement,nom_etablissement,adresse_etablissement,contact_etablissement,slogan_etablissement,date_ajout_eleve,email_etablissement) VALUES(:id,:nom,:addr,:contact,:slogan,NOW(),:mail)');
